                    ...
                    <VStack justifyContent='space-between'>
                        ...
                        <Box softShadow='1' backgroundColor='$white' borderColor={'$blue300'} borderRadius={'$xl'} mt={'$4'}>
                            <Box m={'$2'} my={'$3'} mb={'$5'}>
                                ...
                                <HStack justifyContent={'space-between'} space={'xs'} alignItems={'center'} mb={'$3'}>
                                    <Heading fontSize={'$lg'} bold>Add photo (min 2)</Heading>
                        ...
                        <Box softShadow='1' backgroundColor='$white' borderColor={'$blue300'} borderRadius={'$xl'} mt={'$4'}>
                            <Box m={'$2'} my={'$3'} mb={'$5'}>
                                ...
                                <HStack justifyContent={'space-between'} space={'xs'} alignItems={'center'} mb={'$3'}>
                                    <Heading fontSize={'$lg'} bold>Choose Amenities you have</Heading>
                                    {/* <AppIcon IoniconsName='images-outline' size={22} /> */}
                                </HStack>
                                ...
                                <HStack justifyContent='space-between'>
                                    ...
                                    >
                                        <VStack space={'md'} alignItems={'center'}>
                                            <AppIcon MaterialCommunityIconsName='air-filter' size={33} color={isAmenitySelected('air-conditioner') ? 'green' : 'gray'} />
                                            <Text fontSize={'$md'} bold color={isAmenitySelected('air-conditioner') ? '$green600' : '$coolGray500'}>A/C</Text>
                                        </VStack>
                                    </Pressable>
                                    <Pressable
                                        w={WIDTH * 0.28}
                                    ...
                                    >
                                        <VStack space={'md'} alignItems={'center'}>
                                            <AppIcon IoniconsName='power-sharp' size={33} color={isAmenitySelected('power-backup') ? 'green' : 'gray'} />

                                            <Text fontSize={'$md'} bold color={isAmenitySelected('power-backup') ? '$green600' : '$coolGray500'}>Power Backup</Text>
                                    ...
                                    >
                                        <VStack space={'md'} alignItems={'center'}>
                                            <AppIcon IoniconsName='wifi' size={33} color={isAmenitySelected('cctv') ? 'green' : 'gray'} />

                                            <Text fontSize={'$md'} bold color={isAmenitySelected('cctv') ? '$green600' : '$coolGray500'}>Wifi</Text>
